...
export default interface Stitches<Prefix extends string = '', Media extends {} = {}, Theme extends {} = {}, ThemeMap extends {} = {}, Utils extends {} = {}> {
	...
	css: {
		<Composers extends (string | Solid.Component<any> | Util.Function | { [name: string]: unknown })[], CSS = CSSUtil.CSS<Media, Theme, ThemeMap, Utils>>(
			...composers: {
				[K in keyof Composers]: Composers[K] extends string | Solid.Component | Util.Function // Strings, Solid Components, and Functions can be skipped over
					? Composers[K]
					: RemoveIndex<CSS> & {
	...
	styled: {
		<
			Type extends keyof Solid.JSX.IntrinsicElements | Solid.Component<any> | Util.Function,
			Composers extends (string | Solid.Component<any> | Util.Function | { [name: string]: unknown })[],
			CSS = CSSUtil.CSS<Media, Theme, ThemeMap, Utils>,
		>(
			type: Type,
			...composers: {
				[K in keyof Composers]: Composers[K] extends string | Solid.Component<any> | Util.Function // Strings, Solid Components, and Functions can be skipped over
					? Composers[K]
					: RemoveIndex<CSS> & {
							/** The **variants** property lets you set a subclass of styles based on a key-value pair.
							 *
...
type ThemeTokens<Values, Prefix> = {
	[Scale in keyof Values]: {
		[Token in keyof Values[Scale]]: ThemeUtil.Token<Extract<Token, number | string>, Values[Scale][Token], Extract<Scale, string | void>, Extract<Prefix, string | void>>
	}
}
