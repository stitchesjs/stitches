...
export type IntrinsicElementsKeys = keyof Solid.JSX.IntrinsicElements

/** Returns a new Styled Component. */
export interface StyledComponent<Type = 'span', Props = {}, Media = {}, CSS = {}>
	extends Solid.Component<Util.Assign<Type extends IntrinsicElementsKeys | Solid.Component<any> ? Solid.ComponentProps<Type> : never, TransformProps<Props, Media> & { css?: CSS }>> {
	(
		props: Util.Assign<
		Type extends IntrinsicElementsKeys | Solid.Component<any> 
			? Solid.ComponentProps<Type>
      : never,
	...
	<C extends CSS, As extends string | Solid.Component<any> = Type extends string | Solid.Component<any> ? Type : never>(
		props: Util.Assign<
		Type extends IntrinsicElementsKeys | Solid.Component<any> 
			? Solid.ComponentProps<Type>
      : never,
