 ...
 * @type {import('./types')._StyledSheetFactory}
 */
const factory = (
	/** Configuration */
	init,
	...
	sheet.theme = (
		...
		const themeInit = name == Object(name) ? name : Object(init)
