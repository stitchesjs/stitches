...
describe('Variants', () => {
	...
	test('Renders a component without any initial styles', () => {
		...
		expect(expression.className).toBe('sx03kz9')
	...
	test('Renders a component with 1 matching variant', () => {
		...
		expect(expression1.className).toBe('sx03kz9 sx03kz9tmy8g--size-small')
		...
		expect(expression2.className).toBe('sx03kz9 sx03kz94wpam--color-blue')
	...
	test('Renders a component with 2 matching variants', () => {
		...
		expect(expression.className).toBe('sx03kz9 sx03kz9tmy8g--size-small sx03kz9hmqox--level-1')
	...
	test('Renders a component with a 2 matching variants and 1 matching compound', () => {
		...
		expect(expression.className).toBe('sx03kz9 sx03kz94wpam--color-blue sx03kz9tmy8g--size-small sx03kz9if1wl--c2')
...
describe('Variants with defaults', () => {
	...
	test('Renders a component with the default variant applied', () => {
		...
		expect(expression.className).toBe('sx03kz9 sx03kz9tmy8g--size-small')
	...
	test('Renders a component with the non-default variant explicitly applied', () => {
		...
		expect(expression.className).toBe('sx03kz9 sx03kz9fhyhx--size-large')
...
describe('Conditional variants', () => {
	...
	test('Renders a component with a conditional variant repeatedly', () => {
		...
		expect(component({ size: { bp1: 'small', bp2: 'large' } }).className).toBe(`sx03kz9 sx03kz9iopr6--size-small sx03kz9o7z8s--size-large`)
		expect(toString()).toBe(
