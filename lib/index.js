...
exports.createTokens = function (tokens) {
    return tokens;
};
exports.createCss = function (config, env) {
    ...
    var sheets = utils_1.createSheets(env, config.screens);
    ...
    return new Proxy(noop, {
        ...
        apply: function (_, __, argsList) {
            ...
            var token = config.tokens &&
                config.tokens[utils_1.cssPropToToken[cssProp]];
            var tokenValue;
            if (token) {
